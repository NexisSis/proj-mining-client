                                ...
                                <div class="form-box">
                                    ...
                                    <div class="form-box__group">
                                        <div class="form-box__value form-box__group_value">
                                            <input class="inputText" type="text" aria-describedby="basic-addon"
                                                   placeholder="D:\User Files\Downloads\Document.docx"/>
                                        </div>
                                    ...
                                    <a class="button button--add" href="javascript:void(0)"><i class="add"></i>Добавить
                                        файл</a>
                                </div>
