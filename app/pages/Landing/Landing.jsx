...
class Landing extends React.Component {
    ...
    render() {
        return (
            <div>
                <div class={mainStyle["startNow"]}>

                    <div class={mainStyle["container-fluid"]}>

                        <div class={mainStyle["title"]}><h2>Начни майнинг криптовалют прямо сейчас</h2></div>

                        <div class={mainStyle["startNow-cont"]}>

                            <div class={mainStyle["startNow-box"] + ' '+ mainStyle["startNow-box--instantActivation"]}>
                                <h3>Мгновенная активация</h3>
                                <div class={mainStyle["startNow-box__text"]}>
                                    <p>Вы начинаете майнить сразу после поступления оплаты! Ежедневные начисления</p>
                                </div>
                            </div>

                            <div class={mainStyle["startNow-box"] + ' ' +  mainStyle["startNow-box--quickOutput"]}>
                                <h3>Быстрый вывод</h3>
                                <div class={mainStyle["startNow-box__text"]}>
                            ...
                            <div class={mainStyle["startNow-box"] + ' ' + mainStyle["startNow-box--statistics"]}>
                                <h3>Статистика</h3>
                                <div class={mainStyle["startNow-box__text"]}>
                            ...
                            <div class={mainStyle["startNow-box"] + ' ' +  mainStyle["startNow-box--neuralNetwork"]}>
                            ...
                            <div class={mainStyle["startNow-box"] + ' '+ mainStyle["startNow-box--security"]}>
                                <h3>Безопасность</h3>
                                <div class={mainStyle["startNow-box__text"]}>
                ...
                <div class={mainStyle["contText"]}>

                    <div class={mainStyle["container-fluid"]}>

                        <div class={mainStyle["row"]}>

                            <div class={mainStyle["col-lg-6"] + ' ' + mainStyle["col-md-6"]}>

                                <div class={mainStyle["title"]}><h2>O нас</h2></div>
                                <div class={mainStyle["textBox"]}>
                                    <p>Наша програмное обеспечение использует нейронные сети и искуственный интелект для
                                        выбора оптимального пула. Таким образом вы получаете максимальный возврат от
                                ...
                                <a class={mainStyle["button"]} href="javascript:void(0)">Подробнее</a>

                            </div>
`
                            <div class={mainStyle["col-lg-6"] + ' ' + mainStyle["col-md-6"]}>

                                <div class={mainStyle["contImg"]}>
                                    <a href="javascript:void(0)">
                                        <img src={about} alt='about'/>
                                    </a>
                                    <div class={mainStyle["contImg__play"]}></div>
                                </div>
                ...
                <div class={mainStyle["tariff"]}>

                    <div class={mainStyle["container-fluid"]}>

                        <div class={mainStyle["title"]}><h2>Выберите подходящий тариф и начните зарабатывать прямо сейчас!</h2></div>

                        <div class={mainStyle["tariff-cont"]}>

                            <div class={mainStyle["tariff-box"]}>

                                <div class={mainStyle["tariff-block"]}>
                                    <span class={mainStyle["tariff-block__title"]}>Облачный майнинг<b>Scrypt</b></span>
                                    <ul class={mainStyle["tariff-block__list"]}>
                                    ...
                                    <span class={mainStyle["tariff-block__price"]}><b>$7.50</b>за 10 GH/s </span>
                                    <a class={mainStyle["button"] + ' ' + mainStyle["button--tariffBuy"]} href="javascript:void(0)">Купить</a>
                                </div>
                    ...
                    <div class={mainStyle["container-fluid"]}>
                        ...
                        <div class={mainStyle["row"]}>
                            ...
                            <div class={mainStyle["col-lg-6"] + ' ' + mainStyle["col-md-6"]}>
                                ...
                                <div class={mainStyle["title"]}><h2>Мониторинг</h2></div>
                                <div class={mainStyle["textBox"]}>
                                    <p>Наша програмное обеспечение использует нейронные сети и искуственный интелект для
                                        выбора оптимального пула. Таким образом вы получаете максимальный возврат от
                                        купленной мощности. Статискика ежедневных начислений и прогнозы по вашим доходам
