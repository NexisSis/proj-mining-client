...
import monitoring from "../../../../public/pictures/monitoring.jpg"
import about from "../../../../public/pictures/about-us.jpg"
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="startNow-cont">
                            ...
                            <div class="startNow-box startNow-box--statistics">
                                <h3>Статистика</h3>
                                <div class="startNow-box__text">
                                    <p>Статискика ежедневных начислений и прогнозы по вашим доходам всегда на вашем экране</p>
                                </div>
                            </div>
                            ...
                            <div class="startNow-box startNow-box--neuralNetwork">
                                ...
                                <div class="startNow-box__text">
                                    <p>Наша програмное обеспечение использует нейронные сети и искуственный интелект для выбора оптимального пула. Таким образом вы получаете максимальный возврат от купленной мощности</p>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="textBox">
                                    <p>Наша програмное обеспечение использует нейронные сети и искуственный интелект для выбора оптимального пула. Таким образом вы получаете максимальный возврат от купленной мощности. Статискика ежедневных начислений и прогнозы по вашим доходам всегда на вашем экране. Удобный и быстрый вывод криптовалюты с возможностью реинвестирования. Наша програмное обеспечение использует нейронные сети и искуственный интелект для выбора оптимального пула. Таким образом вы получаете максимальный возврат от купленной мощности. Статискика ежедневных</p>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="contImg">
                                    <a href="javascript:void(0)"><img src={about} alt='about'/></a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="textBox">
                                    <p>Наша програмное обеспечение использует нейронные сети и искуственный интелект для выбора оптимального пула. Таким образом вы получаете максимальный возврат от купленной мощности. Статискика ежедневных начислений и прогнозы по вашим доходам всегда на вашем экране. Удобный и быстрый вывод криптовалюты с возможностью реинвестирования. Наша програмное обеспечение использует нейронные сети и искуственный интелект для выбора оптимального пула. Таким образом вы получаете максимальный возврат от купленной мощности. Статискика ежедневных начислений и прогнозы по вашим доходам всегда на вашем экране. Удобный и быстрый вывод криптовалюты с возможностью реинвестирования.</p>
                                </div>
                                <a class="button" href="javascript:void(0)">Подробнее</a>
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="contImg">
                                    <a href="javascript:void(0)"><img src={monitoring} alt="img" /></a>
                                </div>
